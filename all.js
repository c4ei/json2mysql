...
// console.log(k +":k /"+(L4_Cnt-1)+":L4_Cnt-1");
      ...
      if(j==0) // create table
      {
        ...
        fs.open(fileTBL, 'a+', function(err, fd){ if(err) throw err; console.log(fileTBL +' : file open complete');});
        fs.appendFileSync(fileTBL, sqlCreat + '\n', 'utf-8', function(error){ console.log(fileTBL + ' : error - write'); });        
      }
...
////////////////////////////////////////////////////////////////
      ...
      fs.open(file_ins, 'a+', function(err, fd){ if(err) throw err; console.log(TABLE_NAME +' : file open complete'); });
      fs.appendFileSync(file_ins, sqlIns1 + '\n', 'utf-8', function(error){ console.log('error - write');});
      ////////////////////////////////////////////////////////////////
